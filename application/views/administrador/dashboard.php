                    ...
                    <div class="row">
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-aqua">
                                <div class="inner">
                                    ...
                                    <p>
                                        Registro de Insituciones   
                                    </p>
                                </div>
                                <div class="icon">
                                    <i class="ion ion-bag"></i>
                                </div>
                                <a href="agregarInstitucion.html" class="small-box-footer">
                        ...
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-green">
                                ...
                                <a href="agregarUsuario.html" class="small-box-footer">
                                    Acceder <i class="fa fa-arrow-circle-right"></i>
                                </a>
                            </div>
                        </div><!-- ./col -->
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-yellow">
                                ...
                                <a href="perfilAdm.html" class="small-box-footer">
                                    Acceder <i class="fa fa-arrow-circle-right"></i>
                                </a>
                            </div>
                        </div><!-- ./col -->
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-red">
                                <div class="inner">
                                    ...
                                    <p>
                                        Informacion y Graficos  
                                    </p>
                                </div>
                                <div class="icon">
                                    <i class="ion ion-person-add"></i>
                                </div>
                                <a href="visorInformacionAdm.html" class="small-box-footer">
                                    Acceder <i class="fa fa-arrow-circle-right"></i>
                                </a>
                            </div>
                        </div><!-- ./col -->
                        ...
                        <section class="col-lg-6 connectedSortable"> 
                                    ...
                                    <div class="pull-right box-tools">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu pull-right" role="menu">
                                                ...
                                                <li><a href="#">Limpiar calendario</a></li>
                                                <li class="divider"></li>
                            ...
                            <div class="box box-info">
                                <div class="box-header">
                                    ...
                                    <!-- tools box -->
                                    <div class="pull-right box-tools">
                                        <button class="btn btn-info btn-sm" data-widget="remove" data-toggle="tooltip" title="Quitar"><i class="fa fa-times"></i></button>
                                    </div><!-- /. tools -->
                                </div>
                                <div class="box-body">
                        ...
                        <section class="col-lg-6 connectedSortable">
                            ...
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                    <ul class="todo-list">
                                        <li>
                                            ...
                                            <!-- todo text -->
                                            <span class="text">Actualizar Base de datos</span>
                                            <!-- Emphasis label -->
                                        ...
                                        <li>
                                            ...
                                            <input type="checkbox" value="" name=""/>
                                            <span class="text">Realizar Parada Programada</span>
                                        ...
                                        <li>
                                            ...
                                            <input type="checkbox" value="" name=""/>
                                            <span class="text">Actualizar Plan de Contingencia</span>
                                        ...
                                        <li>
                                            ...
                                            <input type="checkbox" value="" name=""/>
                                            <span class="text">Corregir formularios de ingreso</span>
                                        ...
                                        <li>
                                            ...
                                            <input type="checkbox" value="" name=""/>
                                            <span class="text">Finalizar docuemtacion</span>
                                        ...
                                        <li>
                                            ...
                                            <input type="checkbox" value="" name=""/>
                                            <span class="text">Editar datos de Adminitracion</span>
                                ...
                                <div class="box-footer clearfix no-border">
                                    <button class="btn btn-default pull-right"><i class="fa fa-plus"></i> Añadir Item</button>
                                </div>
                            </div><!-- /.box -->
