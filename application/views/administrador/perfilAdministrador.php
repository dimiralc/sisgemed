<aside class="right-side">                
                ...
                <section class="content-header">
                    <h1>
                        Peril Administrador
                        <small>Adminitrador del sistema</small>
                    </h1>
                    <ol class="breadcrumb">
                ...
                <section class="content">
                    <div class="box box-primary">
                       <div class="box-header">
                            <h3 class="box-title">Hola, Administrador del Sistema</h3>
                        </div><!-- /.box-header -->
                        <div class="box-body">
                            <form role="form">
                                <!-- text input -->
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="administrador@sisgemed.cl" />
                                </div> 
                                <div class="form-group">
